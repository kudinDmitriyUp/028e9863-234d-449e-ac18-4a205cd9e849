...
export const metadata: Metadata = {
  title: "EuroTrip - European Travel Booking Platform",
  description: "Book flights, hotels, and car rentals for your European adventure. Discover Paris, Rome, Barcelona, Prague, Vienna with our curated travel packages and seamless booking experience.",
  keywords: "European travel, flight booking, hotel booking, car rental, Paris, Rome, Barcelona, Prague, Vienna, travel packages, Europe trips",
  metadataBase: new URL("https://eurotrip.com"),
  alternates: {
    canonical: "https://eurotrip.com"
  },
  openGraph: {
    title: "EuroTrip - European Travel Booking Platform",
    description: "Book flights, hotels, and car rentals for your European adventure. Discover iconic destinations with our curated travel packages.",
    url: "https://eurotrip.com",
    siteName: "EuroTrip",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34Qgyh3s7JYDSgc82AIVt5yiftd/uploaded-1763394655411-w7kjzjdk.jpg",
  ...
  twitter: {
    ...
    title: "EuroTrip - European Travel Booking Platform",
    description: "Book flights, hotels, and car rentals for your European adventure. Discover iconic destinations with seamless booking.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_34Qgyh3s7JYDSgc82AIVt5yiftd/uploaded-1763394655411-w7kjzjdk.jpg"]
  },
  robots: {
    index: true,
    follow: true
